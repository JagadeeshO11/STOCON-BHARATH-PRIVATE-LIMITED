  ...
  return (
    <>
      <section className="page-hero page-hero--contact">
        <AnimatedPageHero
          label="CONTACT STOCON"
          prefix="Let's begin the"
          typed="conversation."
          description="Share your product or export requirement and connect with STOCON BHARATH PRIVATE LIMITED."
        />
      </section>
        ...
        <div className="contact-page__details">
          ...
          {company.phoneNumbers.map((person) => (
            <motion.a
              ...
              viewport={{ once: true }}
              whileHover={{ x: 6 }}
              href={'tel:+91' + person.number}
            >
              <Phone size={22} />
              <div>
                <small>{person.name.toUpperCase()}</small>
                <strong>+91 {person.number}</strong>
              </div>
              <ArrowRight size={18} />
            </motion.a>
          ))}
          ...
          >
            ...
            <div>
              ...
              <strong>Start a business conversation</strong>
            </div>
            <ArrowRight size={18} />
          </motion.a>
        </div>
