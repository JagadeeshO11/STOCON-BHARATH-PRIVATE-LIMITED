...
export function AnimatedPageHero({label,prefix,typed,description}:Props){
 ...
 return <div className="animated-page-hero">
  ...
  <motion.h1 initial={{opacity:0,y:22}} animate={{opacity:1,y:0}} transition={{duration:.6,delay:.12}} className="typewriter-heading">
   <span className="typewriter-prefix">{prefix}&nbsp;</span><em className="typewriter-word">{value}</em>
  </motion.h1>
