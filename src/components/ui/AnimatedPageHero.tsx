...
export function AnimatedPageHero({label,prefix,typed,description}:Props){
 ...
 return <div className="animated-page-hero">
  ...
  <motion.h1 initial={{opacity:0,y:22}} animate={{opacity:1,y:0}} transition={{duration:.6,delay:.12}}>{prefix} <em className="typewriter-word" aria-label={typed}><span className="typewriter-slot">{value}</span><span className="typewriter-caret" aria-hidden="true">|</span></em></motion.h1>
