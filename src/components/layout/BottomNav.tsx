import { FaHouse, FaCircleInfo, FaShip, FaShieldHalved, FaWhatsapp } from 'react-icons/fa6'
import { NavLink } from 'react-router-dom'
import { company } from '../../constants/company'
import './BottomNav.css'

const items=[['/','Home',FaHouse],['/about','About',FaCircleInfo],['/export-services','Export',FaShip],['/quality','Quality',FaShieldHalved]] as const
